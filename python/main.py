...
import user
import pdk
from dac_design import design_dac, simulate_dac, layout_dac
...
# Design circuit
print('\nCircuit design:')
spice_params, layout_params = design_dac(RESOLUTION, IDEAL_WIDTH, RES_NUMBER, MAX_NL, target_R_th, POLY_W)
# match TOPOLOGY:
#     case 0:     # R2R-ladder RDAC
#         spice_params, BIT_WIDTH = design_r2r_rdac(RESOLUTION, IDEAL_WIDTH, RES_NUMBER, MAX_NL, target_R_th, POLY_W)
#     case 1:     # Binary-weighted RDAC
