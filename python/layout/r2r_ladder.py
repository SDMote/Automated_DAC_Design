...
def layout_r2r_rdac(RES_LENGHT, N_RES):
    RES_W = RHIa
    M1_RES = RES_W
    ...
    ## Save temp GDS
    layout.write(LAYOUT_PATH + "/r2r_bit_0.gds")
    ...
    if N_RES == 1:
        ...
        port(top_cell, layer_m1, "n0", xoffset-temp, yoffset, xoffset-temp+PSDb/2, yoffset+RES_W)
    elif N_RES == 2:
        paint(top_cell, layer_m1, xoffset-temp, yoffset-M1_RES/2, xoffset+RES_W, yoffset+M1_RES/2)
        port(top_cell, layer_m1, "n0", xoffset-temp, yoffset-M1_RES/2, xoffset-PSDc, yoffset+M1_RES/2)
    else:
        pass

    print(" Writing R-2R GDS")
    layout.write(LAYOUT_PATH + "/r2r_bit_i.gds")
    ...
    layout.dbu = pdk.DBU                            # set database unit
    layout.read(LAYOUT_PATH + "/r2r_bit_0.gds")         # load common part
